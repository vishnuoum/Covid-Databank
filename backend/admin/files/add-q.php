...
<?php
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="#">Add question <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  ?>
  <div class="container">
    <form action="add-question.php" id="form">
        <div class="form-group">
            <label for="question">Question</label>
            <input type="text" class="form-control" name="question" id="question" placeholder="Enter a question" required autocomplete="no-fill">
        </div>
        <div class="form-group">
